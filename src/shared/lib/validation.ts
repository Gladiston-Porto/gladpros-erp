...
export const mfaResendSchema = z.object({
  ...
  tipoAcao: z
    .enum(['LOGIN', 'PRIMEIRO_ACESSO', 'RESET_PASSWORD', 'RESET', 'DESBLOQUEIO'])
    .optional(),
...
export const userUpdateApiSchema = z
  .object({
    ...
    endereco1: optionalNonEmptyString,
    endereco2: optionalNonEmptyString,
    cidade: optionalNonEmptyString,
    estado: optionalNonEmptyString,
    cep: z
      .union([z.string(), z.null()])
      .optional()
      .or(z.literal(''))
    ...
    anotacoes: optionalNonEmptyString,
    expiresAt: z
      .union([z.string(), z.date(), z.null()])
      .optional()
      .transform((v) => {
