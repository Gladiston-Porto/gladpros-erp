...
export const userUpdateApiSchema = z.object({
  ...
  endereco1: z.union([z.string(), z.null()]).optional().or(z.literal('')).transform((s) => (s && s !== null ? s : undefined)),
  endereco2: z.union([z.string(), z.null()]).optional().or(z.literal('')).transform((s) => (s && s !== null ? s : undefined)),
  cidade: z.union([z.string(), z.null()]).optional().or(z.literal('')).transform((s) => (s && s !== null ? s : undefined)),
  estado: z.union([z.string(), z.null()]).optional().or(z.literal('')).transform((s) => (s && s !== null ? s : undefined)),
  cep: z
    .union([z.string(), z.null()])
    .optional()
    .or(z.literal(''))
    .transform((s) => (s && s !== null ? s : undefined))
    .refine((v) => {
      if (!v) return true;
