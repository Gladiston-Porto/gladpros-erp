...
export const POST = withErrorHandler(async (request: Request) => {
  ...
  try {
    ...
    const cookieHeader = (request.headers as { get?: (key: string) => string | undefined }).get?.("cookie") as string | undefined;
    ...
    const authHeader = (request.headers as { get?: (key: string) => string | undefined }).get?.('authorization') as string | undefined;
