...
import { revokeTokensForSession } from '@/lib/auth/token-service';
...
export const DELETE = withErrorHandler(
      ...
      return NextResponse.json(
        {
          ...
          message: 'A sessão não existe ou não pertence a você',
          success: false,
        },
        { status: 404 },
      );
  ...
  `;
    ...
    await revokeTokensForSession(sessionId, 'Sessão revogada pelo usuário');
