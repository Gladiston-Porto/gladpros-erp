 ...
 * Card para exibir movimentação na listagem
 */
...
const TIPO_CONFIG = {
  ...
  SAIDA: { icon: ArrowUpCircle, color: 'text-red-600', bg: 'bg-red-50', label: 'Saída' },
  TRANSFERENCIA: { icon: ArrowLeftRight, color: 'text-blue-600', bg: 'bg-blue-50', label: 'Transferência' },
  ...
  DEVOLUCAO: { icon: RotateCcw, color: 'text-blue-600', bg: 'bg-blue-50', label: 'Devolução' },
