...
describe('POST /api/auth/mfa/verify', () => {
  ...
  it('should return 429 when rate limited', async () => {
    ...
    ;(mockRequest.json as jest.Mock).mockResolvedValue({ userId: 1, code: '123456' })
  ...
  it('should return 401 for invalid MFA code', async () => {
    ...
    ;(mockRequest.json as jest.Mock).mockResolvedValue({ userId: 1, code: '000000' })
  ...
  it('should return 404 when user not found after MFA validation', async () => {
    ...
    ;(mockRequest.json as jest.Mock).mockResolvedValue({ userId: 999, code: '123456' })
