...
export default function DespesaFormPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.dataVencimento && formData.dataEmissao) {
      ...
      if (vencimento < emissao) {
        newErrors.dataVencimento = 'Data de vencimento deve ser >= data de emissão';
      }
    }
    if (formData.requerAprovacao && !formData.aprovadorId) {
      newErrors.aprovadorId = 'Aprovador é obrigatório quando requer aprovação';
    }
    if (formData.requerAprovacao && (!formData.justificativa || formData.justificativa.length < 10)) {
      newErrors.justificativa = 'Justificativa deve ter no mínimo 10 caracteres';
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Ex: Salário do mês de outubro"
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            {formData.requerAprovacao && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                ...
                {/* Aprovador ID (simulado - em produção seria um select de usuários) */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Por que esta despesa necessita aprovação?"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent ${
