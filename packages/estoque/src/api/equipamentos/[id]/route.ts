...
async function getHandler(
  ...
  // 3. LOG
  logger.info(`Buscando equipamento ${params.id}`, createLogContext(request, user));
...
async function putHandler(
  ...
  // 3. LOG
  logger.info(`Atualizando equipamento ${params.id}`, createLogContext(request, user));
...
async function deleteHandler(
  ...
  // 3. LOG
  logger.info(`Excluindo equipamento ${params.id}`, createLogContext(request, user));
