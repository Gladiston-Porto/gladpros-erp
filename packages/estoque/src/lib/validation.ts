...
export const alocacaoEquipamentoSchema = z.object({
  ...
  condicaoSaida: z.enum(['EXCELENTE', 'BOM', 'REGULAR', 'RUIM'] as const),
...
export const devolucaoEquipamentoSchema = z.object({
  condicaoRetorno: z.enum(['EXCELENTE', 'BOM', 'REGULAR', 'RUIM'] as const),
...
export const compraSchema = z.object({
  tipo: z.enum(['MATERIAL', 'EQUIPAMENTO', 'MISTO'] as const),
