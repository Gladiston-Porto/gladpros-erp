...
import { formatCurrency, formatQuantity } from '@gladpros/estoque/lib/utils/formatters';
import { MATERIAL_TIPOS_MAP } from '@gladpros/estoque/lib/utils/constants';
import { cn } from '@/shared/lib/utils';
import type { Material } from '@gladpros/estoque/lib/types';
        ...
        <CardContent className="space-y-3">
          ...
          {material.ultimoCusto && (
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground">Ãšltimo Custo:</span>
          ...
          {abaixoMinimo && (
            <div className="flex items-center gap-2 rounded-md bg-destructive/10 p-2 text-xs text-destructive">
              ...
              <span className="font-medium">Estoque abaixo do mÃ­nimo</span>
            </div>
          )}
          ...
          {abaixoPontoReposicao && !abaixoMinimo && (
            <div className="flex items-center gap-2 rounded-md bg-yellow-500/10 p-2 text-xs text-yellow-700 dark:text-yellow-500">
              ...
              <span className="font-medium">Atingiu ponto de reposiÃ§Ã£o</span>
            </div>
          )}
          ...
          {(material.fabricante || material.modelo) && (
            <div className="text-xs text-muted-foreground">
              ...
              {material.fabricante && material.modelo && <span> â€¢ </span>}
