...
export function StatCard({
  ...
  return (
    <div
      ...
      data-title={title}
      data-change={change !== undefined ? String(change) : undefined}
      className={cn(
        // Base
    ...
    >
      ...
      {icon && (
        <div
          className={cn('absolute top-3.5 right-3.5', iconColorVariants({ variant }))}
          aria-hidden
        >
          {icon}
        </div>
      ...
      <p
        ...
        className="mt-1.5 text-3xl font-bold text-foreground tabular-nums leading-none"
      >
        {displayValue}
      </p>
