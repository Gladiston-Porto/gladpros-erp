...
module.exports = {
  ...
  rules: {
    ...
    'scope-enum': [1, 'always', [
      'usuarios', 'clientes', 'propostas', 'projetos',
      'service-orders', 'estoque', 'financeiro', 'invoices',
      'rh', 'workforce', 'reports', 'analytics', 'dashboard',
      'auth', 'portal', 'configuracoes',
      'deps', 'ci', 'build', 'docs', 'schema', 'scripts',
      'meta-qualidade',
    ]],
  ...
  // Ignorar commits de merge e do Copilot co-author
  ignores: [
